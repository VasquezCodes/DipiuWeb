            ...
            <div className="container mx-auto px-6 py-8 md:py-10 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-8">
                ...
                <div className="flex-1 flex justify-center items-center">
                    <div className="flex gap-4">
                        ...
                        {/* Instagram */}
                        <a href="https://www.instagram.com/dipiutiramisu/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-dipiu-beige rounded-full flex items-center justify-center text-dipiu-red hover:bg-white transition-colors duration-300">
                            <svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
